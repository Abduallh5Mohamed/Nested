...
const HourglassLoader = () => {
  return (
    <div className="text-primary">
      <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img" height="112px" width="112px" viewBox="0 0 56 56" className="hourglass-loader">
        ...
        <g transform="translate(2,2)">
          <g transform="rotate(-90,26,26)" strokeLinecap="round" strokeDashoffset="153.94" strokeDasharray="153.94 153.94" stroke="hsl(var(--primary))" fill="none">
